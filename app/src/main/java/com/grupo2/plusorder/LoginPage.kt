...
class LoginPage : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val loginBt = findViewById<View>(R.id.Entrar) as Button

        loginBt.setOnClickListener{

            // Get email and password
            val emailText = findViewById<TextView>(R.id.editTextTextEmailAddress).text as? String?
            val passText = findViewById<TextView>(R.id.editTextTextPassword).text as? String?
